...
impl Task {
    ...
    fn new(computing_time: f64, deadline: usize, period: usize) -> Self {
        Task {
            ...
            deadline,
            period,
            multiplier: Task::find_mult(computing_time),
        }
    }

    /**
     * Finds minimum multiplier for a float to have no decimal value.
     * Up to MAX_MULT.
     */
    fn find_mult(f: f64) -> f64 {
        let mut mult = 1.0;
     ...
     * Retorna el temps de comput de la task
     */
    fn get_computing_time_mult(&self) -> usize {
    ...
    fn set_multiplier(&mut self, mult: usize) {
     ...
     * Retorna el deadline de la task
     */
    fn get_deadline_mult(&self) -> usize {
